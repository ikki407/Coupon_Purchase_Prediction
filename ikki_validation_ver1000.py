...
for feature in user_content.columns.drop('user_id_hash'):
	...
	IDF_l = -np.log2(gamma / float(num_user)) + 1.5
...
pred_ikki.to_csv('/Users/IkkiTanaka/Documents/kaggle/Coupon_Purchase_Prediction/prediction/ikki0911_pred29.csv',index=False)
