...
a = a.iloc[(a['item_count']<100).values,:]
...
pred_ikki.to_csv('/Users/IkkiTanaka/Documents/kaggle/Coupon_Purchase_Prediction/prediction/ikki0911_pred26.csv',index=False)
