...
#20120501より後
#train = train.iloc[(train[u'I_DATE']>=(datetime.datetime(2012,01,01).toordinal() - 734318)).values,:]
...
submission = submission.sort("USER_ID_hash")
submission.to_csv('/Users/IkkiTanaka/Documents/kaggle/Coupon_Purchase_Prediction/prediction/simple_pred1_top3.csv',index=False)


submission['PURCHASED_COUPONS'] = submission['PURCHASED_COUPONS'].apply(lambda x: str(x)[:98])
