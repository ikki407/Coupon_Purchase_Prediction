...
#validation期間
val_period = ['2012-06-17','2012-06-23']#[from,end]
...
cpdtr_va = cpdtr.iloc[(cpdtr['i_date']<=val_period[1]).values,:]
...
cpltr_va = cpltr.iloc[(cpltr['dispfrom']<=val_period[1]).values,:]
...
content_coupon = content_coupon.iloc[~(content_coupon['coupon_id_hash'].isin(['01c57ee59e2e2563a2f4785a6e8b2e80','6d0a997acf143496aa621867244efac7'])).values,:]
...
o.loc[(o['user_id_hash'].isin(user_notin_tr)).values,['coupon_id_rank1','coupon_id_rank2']] = ['01c57ee59e2e2563a2f4785a6e8b2e80','6d0a997acf143496aa621867244efac7']

cplte.sort('discount_price')
...
print 'APのvalidationスコア: ', val_score
