...
#Vの宅配を2にする
V['genre_name_宅配'] = V['genre_name_宅配']*2
...
pred_ikki.to_csv('/Users/IkkiTanaka/Documents/kaggle/Coupon_Purchase_Prediction/prediction/ikki0911_pred33.csv',index=False)
