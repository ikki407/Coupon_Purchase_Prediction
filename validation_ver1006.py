...
feature_label = [u'coupon_id_hash', u'user_id_hash',u'genre_name',u'large_area_name', u'ken_name',u'small_area_name_y','discount_price','price_rate','catalog_price','capsule_text']
all_data = user_item_tr[feature_label]
all_data.columns = [u'coupon_id_hash', u'user_id_hash',u'genre_name',u'large_area_name', u'ken_name',u'small_area_name','discount_price','price_rate','catalog_price','capsule_text']
...
#trainとtestを結合する
feature_label_te = [u'coupon_id_hash',u'genre_name',u'large_area_name', u'ken_name',u'small_area_name','discount_price','price_rate','catalog_price','capsule_text']
#結合する前にTrainの長さを保存する
len_tr = len(all_data)
...
#capsule_textの特殊なのを消す
all_data.loc[(all_data['capsule_text'].isin(['イベント','公共の宿','ゲストハウス','ペンション','民宿','ビューティー','レッスン'])).values,['capsule_text']] = np.nan

del all_data['genre_name']
...
pred_ikki.to_csv('/Users/IkkiTanaka/Documents/kaggle/Coupon_Purchase_Prediction/prediction/ikki0911_pred36.csv',index=False)
