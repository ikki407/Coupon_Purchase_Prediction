...
#discount_priceが100の試供品を抜く
train = train.iloc[(train['discount_price']!=100).values,:]
train['catalog-discount'] = train['catalog_price'] - train['discount_price']

test = test.iloc[(test['discount_price']!=100).values,:]
test['catalog-discount'] = test['catalog_price'] - test['discount_price']
...
pred_ikki.to_csv('/Users/IkkiTanaka/Documents/kaggle/Coupon_Purchase_Prediction/prediction/ikki0911_pred28.csv',index=False)
